...
public class ExceptionHandlerController {
    ...
    public ApiResponseWrapper userCredentialsError(UserAuthenticationException ex) {
        return new ApiResponseWrapper(new ErrorDTO(ex.getMessage(), Collections.emptyList()));
    }
}